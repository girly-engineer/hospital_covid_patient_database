...
//  project_3
//
//  Created by Ashley Henriquez on 5/2/21.
//
// cd Desktop/150_Class/project_3/project_3
...
int num_patient_max; /**Will keep track of the number of patients max*/
int old_count; /**Will keep track of the old  of patients max*/
int m; /**Will keep track of the month with max number of patients checked*/
int d; /**Will keep track of the date with max number of patients checked*/
int y; /**Will keep track of the year with max number of patients checked*/
...
typedef struct patient{
    ...
    int check_in_date;
    int check_in_year;
    int month; /**Month Checked in, out, or deceased**/
    int day; /**Month Checked in, out, or deceased**/
    int year;  /**Month Checked in, out, or deceased*/
    int status; /**Patient current status*/
    int origin; /**Patient current status*/
    struct patient *from; /**Patient who they get infected from*/
} patient_Info;
...
void write_menu_choices_to_output(FILE* output_File){
    fprintf(output_File, "Welcome to CoVID-19 Patient Database!\n\n");
...
void do_querys(FILE* output_File, GRAPH *all_Patients){
    ...
    printf("Welcome to CoVID-19 Patient Database!\n\n");
...
void fifth_query_find_connection(GRAPH *all_Patients, FILE* output_File,
    ...
    printf("Find the connection between patients %.6d and %.6d\n", patient_1, patient_2);
    fprintf(output_File,"Find the connection between patients %.6d and %.6d\n", patient_1, patient_2);
